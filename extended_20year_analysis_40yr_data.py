"""
Extended Analysis: Test 20-Year DCA from 1985 onwards using NDX Index
This tests 20-year holding period scenarios with 40+ years of historical data.

Uses NDX (Nasdaq-100 Index) as QQQ proxy back to 1985.
This analysis uses the full 40-year dataset (1985-2026) to test 20-year DCA strategies.
"""
...
print("="*80)
print("EXTENDED ANALYSIS: 20-YEAR DCA WITH 40+ YEARS OF DATA (1985-2026)")
print("="*80)
print("\nUsing NDX (Nasdaq-100 Index) as proxy for QQQ back to 1985")
print("This tests 20-year holding period DCA strategies")
print("Dataset: 40+ years of historical data")
print("="*80)
...
print("  - Holding period: 20 years")
print("  - Start dates: MONTHLY intervals (maximum coverage)")

# NDX DCA
print("\n  [1/2] Simulating NDX (1x) 20-Year DCA...")
...
print("  [2/2] Simulating Synthetic 3x NDX 20-Year DCA...")
...
# Save results
ndx_dca_results.to_csv('data/processed/dca_20year_40yrdata_NDX.csv', index=False)
synthetic_dca_results.to_csv('data/processed/dca_20year_40yrdata_Synthetic3x.csv', index=False)
...
comparison.to_csv('data/processed/20year_40yrdata_comparison.csv', index=False)

print("\n" + "="*80)
print("20-YEAR DCA RESULTS SUMMARY (40+ YEARS OF DATA)")
print("="*80)
...
print("\n" + "="*80)
print("3X LEVERAGED PERFORMANCE DISTRIBUTION (20-YEAR DCA, 40+ YEARS DATA)")
print("="*80)
...
print("\n📊 NDX (1x) 20-YEAR DCA PERFORMANCE:")
...
print("\n📊 SYNTHETIC 3x NDX 20-YEAR DCA PERFORMANCE:")
...
print("\n" + "="*80)
print("PERIOD COMPARISON: RECENT vs HISTORICAL (20-YEAR DCA)")
print("="*80)

# Split into periods - adjust cutoff to account for 20-year holding period
...
print(f"\nRecent Period (1995+): {len(recent)} scenarios")
print(f"Historical Period (1985-1994): {len(historical)} scenarios")

print("\n📊 3x LEVERAGED 20-YEAR PERFORMANCE BY ERA:")
print("-"*80)
print("RECENT PERIOD (1995-2006 starts):")
...
print("\nHISTORICAL PERIOD (1985-1994 starts):")
...
ax1.set_title('3x Leveraged 20-Year DCA: Distribution\n(1985-2006 start dates, 40+ years of data)', 
...
ax1.text(0.98, 0.98, f'n={len(comparison)} scenarios\n40+ years of data', transform=ax1.transAxes,
...
width = 0.35
bars1 = ax2.bar(x - width/2, recent_pct.values, width, label='Recent (1995+)', 
               color='steelblue', alpha=0.8, edgecolor='black')
bars2 = ax2.bar(x + width/2, hist_pct.values, width, label='Historical (1985-1994)', 
               color='darkgreen', alpha=0.8, edgecolor='black')
ax2.set_title('3x Leveraged 20-Year: Recent vs Historical\n(Period Comparison)', 
             fontsize=14, fontweight='bold')
...
ax3.set_title('3x 20-Year CAGR by Start Date\n(Color-coded: Green=Good, Red=Bad)', 
             fontsize=14, fontweight='bold')
...
summary_data = [
    ['Metric', 'Full Period', 'Recent', 'Historical'],
    ['', '', '', ''],
...
ax4.set_title('20-Year DCA Summary Statistics\n(40+ Years of Historical Data)', fontsize=14, fontweight='bold', pad=20)

plt.suptitle('Extended Analysis: 20-Year 3x Leveraged DCA\n(Using 40+ Years of Historical Data: 1985-2026)',
            fontsize=16, fontweight='bold', y=0.98)
plt.tight_layout()
plt.savefig('output/figures/extended_20year_analysis_40yr_data.png', dpi=300, bbox_inches='tight')
print("\n✓ Saved visualization: output/figures/extended_20year_analysis_40yr_data.png")

print("\n" + "="*80)
print("CONCLUSION: 20-YEAR HOLDING PERIOD WITH 40+ YEARS OF DATA")
print("="*80)
...
if diff_median < 5 and diff_loss < 10:
    ...
    print("   - 20-year holding period shows robust performance across 40+ years of data")
else:
    print("\n⚠️ PERIOD-DEPENDENT RESULTS")
    ...
    print("   - Results vary by market period")

print("\n" + "="*80)
print(f"Analysis completed using {(ndx.index[-1] - ndx.index[0]).days / 365.25:.1f} years of historical data")
print(f"Testing {len(comparison)} different 20-year DCA start dates")
print("="*80)
