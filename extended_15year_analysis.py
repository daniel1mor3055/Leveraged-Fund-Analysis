"""
Extended Analysis: Test 15-Year DCA from 1985 onwards using NDX Index
This tests 15-year holding period scenarios instead of 10-year.
...
print("="*80)
print("EXTENDED ANALYSIS: 15-YEAR DCA (1985-2026)")
print("="*80)
print("\nUsing NDX (Nasdaq-100 Index) as proxy for QQQ back to 1985")
print("This tests 15-year holding period DCA strategies")
print("="*80)
...
print("  - Holding period: 15 years")
print("  - Start dates: MONTHLY intervals (maximum coverage)")

# NDX DCA
print("\n  [1/2] Simulating NDX (1x) 15-Year DCA...")
...
print("  [2/2] Simulating Synthetic 3x NDX 15-Year DCA...")
...
# Save results
ndx_dca_results.to_csv('data/processed/dca_15year_NDX.csv', index=False)
synthetic_dca_results.to_csv('data/processed/dca_15year_Synthetic3x.csv', index=False)
...
comparison.to_csv('data/processed/15year_comparison.csv', index=False)

print("\n" + "="*80)
print("15-YEAR DCA RESULTS SUMMARY")
print("="*80)
...
print("\n" + "="*80)
print("3X LEVERAGED PERFORMANCE DISTRIBUTION (15-YEAR DCA)")
print("="*80)
...
print("\n📊 NDX (1x) 15-YEAR DCA PERFORMANCE:")
...
print("\n📊 SYNTHETIC 3x NDX 15-YEAR DCA PERFORMANCE:")
...
print("\n" + "="*80)
print("PERIOD COMPARISON: RECENT vs HISTORICAL (15-YEAR DCA)")
print("="*80)

# Split into periods - adjust cutoff to account for 15-year holding period
...
print("\n📊 3x LEVERAGED 15-YEAR PERFORMANCE BY ERA:")
print("-"*80)
print("RECENT PERIOD (1999-2011 starts):")
...
ax1.set_title('3x Leveraged 15-Year DCA: Distribution\n(1985-2011 start dates)', 
...
ax2.set_title('3x Leveraged 15-Year: Recent vs Historical\n(Period Comparison)', 
             fontsize=14, fontweight='bold')
...
ax3.set_title('3x 15-Year CAGR by Start Date\n(Color-coded: Green=Good, Red=Bad)', 
             fontsize=14, fontweight='bold')
...
ax4.set_title('15-Year DCA Summary Statistics', fontsize=14, fontweight='bold', pad=20)

plt.suptitle('Extended Analysis: 15-Year 3x Leveraged DCA\n(Longer holding period analysis)',
            fontsize=16, fontweight='bold', y=0.98)
plt.tight_layout()
plt.savefig('output/figures/extended_15year_analysis.png', dpi=300, bbox_inches='tight')
print("\n✓ Saved visualization: output/figures/extended_15year_analysis.png")

print("\n" + "="*80)
print("CONCLUSION: 15-YEAR HOLDING PERIOD IMPACT")
print("="*80)
...
if diff_median < 5 and diff_loss < 10:
    ...
    print("   - 15-year holding period shows robust performance")
else:
